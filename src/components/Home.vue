	...
	<el-row class="panel">
		<el-col :span="24" class="panel-top">
			<el-col :span="20" style="font-size:26px;">
				<img src="../assets/logo2.png" class="logo"> <span>电商后台<i style="color:#20a0ff;font-size:20px;">会员管理</i></span>
			</el-col>
			<el-col :span="4">
			...
			<section class="panel-c-c">
				<div class="grid-content bg-purple-light">
					<el-col :span="24" style="margin-bottom:15px;">
						<strong style="width:200px;color: #475669;height:30px;display:inline-block">{{currentPathName}}</strong>
